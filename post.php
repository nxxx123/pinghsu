			...
			<div class="post-header-thumb-cover">
				<div class="post-header-thumb-container">
					...
					<div class="post-header-thumb-meta">
						<time datetime="<?php $this->date('c'); ?>" itemprop="datePublished"><?php echo __('Published on'); ?> <?php $this->date(); ?></time> in <?php $this->category(''); ?> with <a href="#comments"><?php $this->commentsNum(_t(' 0 comment'), _t(' 1 comment'), _t(' %d comments')); ?></a>
					</div>
					<div class="post-tags">
						<?php $this->tags(' ', true, ''); ?>
					</div>
